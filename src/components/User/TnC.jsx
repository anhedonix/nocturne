    ...
    <>
      <div className={classes.body}>
        ...
        <p>
          ...
          {packageVars.name}. All intellectual property rights are reserved. You
          may access this from
          {packageVars.name} for your own personal use subjected to restrictions
        ...
        <ul>
          ...
          <li>Reproduce, duplicate or copy material from {packageVars.name}</li>
        ...
        <p>
          ...
          views and opinions of {packageVars.name},its agents and/or affiliates.
          ...
          {packageVars.name} shall not be liable for the Comments or for any
        ...
        <p>
          ...
          the hyperlink compensates the absence of {packageVars.name}; and (d)
...
const TnCLink = props => {
  return (
    <a href="/TnC" target="_blank">
      <Button color="primary" style={{ minWidth: '0' }}>
        T&C
      </Button>
    </a>
  )
