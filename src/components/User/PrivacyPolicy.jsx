  ...
  return (
    <>
      <div className={classes.body}>
        ...
        <p>
          At {packageVars.name}, accessible from {packageVars.name}.com, one of
        ...
        <p>
          ...
          shared and/or collect in {packageVars.name}. This policy is not
        ...
        <p>
          ...
          advertisements and links that appear on {packageVars.name}, which are
